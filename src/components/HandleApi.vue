<template>
  <div>
    <div class="nav">
      <button @click="snippetAdder">Add snippet</button>
      <button @click="seeLatest">Show latest</button>
      <button @click="bestScore">Higest score</button>
      <button @click="seeReported">Reported snippets</button>
    </div>
